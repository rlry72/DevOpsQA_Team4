...
def test_view_current_score_hse_1fac_adjacent_above():
    """
    Test script to test viewing current score when a single "HSE" and a single "FAC" is on the board and they are adjacent. (TC-07D)
    """
    set_keyboard_input(["2","b2","1","b1","4","0"])
...
def test_view_current_score_hse_1fac_adjacent_below():
    """
    Test script to test viewing current score when a single "HSE" and a single "FAC" is on the board and they are adjacent. (TC-07D)
    """
    set_keyboard_input(["2","b2","1","b3","4","0"])
